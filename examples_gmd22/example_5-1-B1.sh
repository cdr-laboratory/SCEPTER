...
workname="${parent}${branch}${version}_example_wce_5-1-B1_site${f1}"
else
workname="${parent}${branch}${version}_example_5-1-B1_site${f1}"
fi
...
echo "0.0			duration of dust app [yr]" >> $FILE2
