...
echo "1           erosion scheme: 0-- cnst w, 1-- cnst poro*w, 2-- cnst (1-poro)*w, 3--- w-flexible(cnst porosity prof), if not defined 0 is taken" >> $FILE
...
echo "true            porosity  iteration" >> $FILE
