...
def get_input(outdir,runtype,nz,src_code_id,act_ON_in,allow_prec,scheme_act,dt_nonfix_on,ver): 
    ...
    if runtype == 'init':
        ...
        atm_list=[('pco2',3.17e-4),('po2',0.21),('pnh3',0),('pn2o',0)] # bounary conditions 
        restart=true 
        runname_restart=f'{outdir}AMD3/test{src_code_id}_init_{nz:d}{ver}'
...
def main():
    ...
    runname = f'AMD3/test{src_code_id}_{runtype}_{nz:d}'
    runname = f'AMD3/test{src_code_id}_{runtype}_{nz:d}{ver}'
